...
(function () {
  ...
  class CompleteIrrigationPanel extends HTMLElement {
    ...
    async _fetchActiveRuns() {
      ...
      try {
        ...
        // Pre-v1.10.1 backends don't have this command — no-op, fall
    ...
    _renderNotifications() {
      ...
      return (
        ...
        `<span class="version-pill">v1.10.1</span></header>` +
    ...
    _renderSettings() {
      ...
      return (
        ...
        `<tr><td>Version</td><td><strong>v1.10.1</strong></td></tr>` +
    ...
    _renderToday() {
      ...
      return (
        ...
        `<span class="version-pill">v1.10.1</span></div></header>` +
    ...
    _styles() {
      return (
        ...
        `.schedule-time-row input[type=time]{font-size:15px;text-align:center;max-width:170px}` +
        `.row-2 > *{min-width:0}` +
  ...
  console.info("[complete-irrigation] panel registered, version v1.10.1");
})();
